...
error1 = rospy.Publisher("error1", Float32, queue_size=1)
error2 = rospy.Publisher("error2", Float32, queue_size=1)
error3 = rospy.Publisher("error3", Float32, queue_size=1)
r = rospy.Rate(100)
